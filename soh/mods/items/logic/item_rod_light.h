...
static ColliderCylinderInit sLightRodProjColInit = { { COLTYPE_NONE, AT_ON | AT_TYPE_PLAYER, AC_NONE, OC1_NONE,
...
static ColliderCylinderInit sLightRodSpinColInit = { { COLTYPE_NONE, AT_ON | AT_TYPE_PLAYER, AC_NONE, OC1_NONE,
                                                       OC2_NONE, COLSHAPE_CYLINDER },
                                                     { ELEMTYPE_UNK2,
...
static ColliderCylinderInit sLightRodBeamColInit = { { COLTYPE_NONE, AT_ON | AT_TYPE_PLAYER, AC_NONE, OC1_NONE,
                                                       OC2_NONE, COLSHAPE_CYLINDER },
                                                     { ELEMTYPE_UNK2,
