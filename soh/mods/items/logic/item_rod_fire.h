...
static ColliderCylinderInit sFireRodProjColInit = { { COLTYPE_NONE, AT_ON | AT_TYPE_PLAYER, AC_NONE, OC1_NONE, OC2_NONE,
                                                      COLSHAPE_CYLINDER },
                                                    { ELEMTYPE_UNK2,
...
static ColliderCylinderInit sFireRodSpinColInit = { { COLTYPE_NONE, AT_ON | AT_TYPE_PLAYER, AC_NONE, OC1_NONE, OC2_NONE,
                                                      COLSHAPE_CYLINDER },
                                                    { ELEMTYPE_UNK2,
...
static ColliderCylinderInit sFireRodFlameColInit = { { COLTYPE_NONE, AT_ON | AT_TYPE_PLAYER, AC_NONE, OC1_NONE,
