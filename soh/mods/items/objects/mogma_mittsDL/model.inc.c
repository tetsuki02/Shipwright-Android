...
Gfx gMogmaMittsGiveDL[] = {
    gsSPDisplayList(gMogmaMittsWhiteColorDL), gsSPDisplayList(gMogmaMittsDL), gsSPDisplayList(gMogmaMittsPlateColorDL),
    gsSPDisplayList(gMogmaMittsPlateDL),      gsSPEndDisplayList(),
};
