...
static Vtx sGemVtxFront[] = {
    ...
    // indices 9-16
    VTX(  25,  45, DEPTH,  512, 512,  COL_BLUE_BRIGHT_R, COL_BLUE_BRIGHT_G, COL_BLUE_BRIGHT_B, 0xFF), // 9  - between N and NE
    VTX(  45,  25, DEPTH,  512, 512,  COL_BLUE_BRIGHT_R, COL_BLUE_BRIGHT_G, COL_BLUE_BRIGHT_B, 0xFF), // 10 - between NE and E
    VTX(  45, -25, DEPTH,  512, 512,  COL_BLUE_BRIGHT_R, COL_BLUE_BRIGHT_G, COL_BLUE_BRIGHT_B, 0xFF), // 11 - between E and SE
    VTX(  25, -45, DEPTH,  512, 512,  COL_BLUE_BRIGHT_R, COL_BLUE_BRIGHT_G, COL_BLUE_BRIGHT_B, 0xFF), // 12 - between SE and S
    VTX( -25, -45, DEPTH,  512, 512,  COL_BLUE_BRIGHT_R, COL_BLUE_BRIGHT_G, COL_BLUE_BRIGHT_B, 0xFF), // 13 - between S and SW
    VTX( -45, -25, DEPTH,  512, 512,  COL_BLUE_BRIGHT_R, COL_BLUE_BRIGHT_G, COL_BLUE_BRIGHT_B, 0xFF), // 14 - between SW and W
    VTX( -45,  25, DEPTH,  512, 512,  COL_BLUE_BRIGHT_R, COL_BLUE_BRIGHT_G, COL_BLUE_BRIGHT_B, 0xFF), // 15 - between W and NW
    VTX( -25,  45, DEPTH,  512, 512,  COL_BLUE_BRIGHT_R, COL_BLUE_BRIGHT_G, COL_BLUE_BRIGHT_B, 0xFF), // 16 - between NW and N
