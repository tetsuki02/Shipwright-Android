...
Gfx gBombarrowsGiveDL[] = {
    gsSPDisplayList(sArrowShaftDL),       gsSPDisplayList(sBombBagColorDL), gsSPDisplayList(sBombBagDL),
    gsSPDisplayList(sBombBagRingColorDL), gsSPDisplayList(sBombBagRingDL),  gsSPEndDisplayList(),
};
