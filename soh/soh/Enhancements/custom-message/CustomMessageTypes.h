...
typedef enum {
    ...
    TEXT_DESC_DEKU_LEAF,
    TEXT_DESC_SWITCH_HOOK,
    TEXT_DESC_MOGMA_MITTS,
    TEXT_DESC_GUST_JAR,
    TEXT_DESC_BALL_AND_CHAIN,
    TEXT_DESC_WHIP,
    TEXT_DESC_SPINNER,
    TEXT_DESC_CANE_OF_SOMARIA,
    TEXT_DESC_DOMINION_ROD,
    TEXT_DESC_TIME_GATE,
    TEXT_DESC_BOMB_ARROWS,
    TEXT_DESC_FIRE_ROD,
    TEXT_DESC_ICE_ROD,
    TEXT_DESC_LIGHT_ROD,
    TEXT_DESC_BEETLE,
    TEXT_DESC_SHOVEL,
    TEXT_DESC_MINISH_CAP,
    TEXT_DESC_LANTERN,
    TEXT_DESC_CHATEAU_ROMANI,
    TEXT_DESC_POKEBALL,
    // MM Masks with effects
    TEXT_DESC_MASK_ALL_NIGHT = 0x9420,
    TEXT_DESC_MASK_BLAST,
    TEXT_DESC_MASK_STONE,
    TEXT_DESC_MASK_GREAT_FAIRY,
    TEXT_DESC_MASK_DEKU,
    TEXT_DESC_MASK_BUNNY,
    TEXT_DESC_MASK_DON_GERO,
    TEXT_DESC_MASK_GORON,
    TEXT_DESC_MASK_ROMANI,
    TEXT_DESC_MASK_COUPLE,
    TEXT_DESC_MASK_ZORA,
    TEXT_DESC_MASK_KAMARO,
    TEXT_DESC_MASK_CAPTAIN,
    TEXT_DESC_MASK_FIERCE_DEITY,
    // SW97 Arrows
    TEXT_DESC_SW97_ARROW_FIRE = 0x9438,
    TEXT_DESC_SW97_ARROW_ICE,
    TEXT_DESC_SW97_ARROW_LIGHT,
    TEXT_DESC_SW97_ARROW_DARK,
    TEXT_DESC_SW97_ARROW_SOUL,
    TEXT_DESC_SW97_ARROW_WIND,
    // Extended Equipment
    TEXT_DESC_EXT_BYRNA = 0x943E,
    TEXT_DESC_EXT_FOUR_SWORD,
    ...
    TEXT_DESC_EXT_BREASTPLATE,
    TEXT_DESC_EXT_CHAMPION_TUNIC,
    TEXT_DESC_EXT_PEGASUS_ANKLET,
    TEXT_DESC_EXT_PENDANT_MEMORIES,
    TEXT_DESC_EXT_WATER_DRAGON_SCALE,
    // SW97 Medallions
    TEXT_DESC_MEDALLION_FOREST = 0x944A,
    TEXT_DESC_MEDALLION_FIRE,
    TEXT_DESC_MEDALLION_WATER,
    TEXT_DESC_MEDALLION_SPIRIT,
    TEXT_DESC_MEDALLION_SHADOW,
    TEXT_DESC_MEDALLION_LIGHT,
    // Vanilla OOT usable items (0x9450+)
    TEXT_DESC_V_STICK = 0x9450,
    TEXT_DESC_V_NUT,
    TEXT_DESC_V_BOMB,
    TEXT_DESC_V_BOW,
    TEXT_DESC_V_ARROW_FIRE,
    TEXT_DESC_V_DINS_FIRE,
    TEXT_DESC_V_SLINGSHOT,
    TEXT_DESC_V_OCARINA_FAIRY,
    TEXT_DESC_V_OCARINA_TIME,
    TEXT_DESC_V_BOMBCHU,
    TEXT_DESC_V_HOOKSHOT,
    TEXT_DESC_V_LONGSHOT,
    TEXT_DESC_V_ARROW_ICE,
    TEXT_DESC_V_FARORES_WIND,
    TEXT_DESC_V_BOOMERANG,
    TEXT_DESC_V_LENS,
    TEXT_DESC_V_BEAN,
    TEXT_DESC_V_HAMMER,
