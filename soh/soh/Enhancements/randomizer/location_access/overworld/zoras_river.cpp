...
void RegionTable_Init_ZoraRiver() {
    ...
    areaTable[RR_ZR_FRONT] = Region("ZR Front", SCENE_ZORAS_RIVER, {}, {
        ...
        LOCATION(RC_ZR_BOULDER_1,            logic->IsChild && logic->CanBreakBoulder()),
        LOCATION(RC_ZR_BOULDER_2,            logic->IsChild && logic->CanBreakBoulder()),
        LOCATION(RC_ZR_BOULDER_3,            logic->IsChild && logic->CanBreakBoulder()),
        LOCATION(RC_ZR_BOULDER_4,            logic->IsChild && logic->CanBreakBoulder()),
    ...
    areaTable[RR_ZR_ATOP_LADDER] = Region("ZR Atop Ladder", SCENE_ZORAS_RIVER, {
        ...
        LOCATION(RC_ZR_UPPER_CIRCLE_BOULDER,                logic->CanBreakBoulder()),
