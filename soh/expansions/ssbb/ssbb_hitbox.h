...
#define SSBB_HITBOX_ELECTRIC_SMALL { 5, {0,0,0}, 25, 35, 4, SSBB_DMG_ELECTRIC, TOUCH_SFX_WOOD }
#define SSBB_HITBOX_ELECTRIC_MED   { 5, {0,0,0}, 35, 40, 6, SSBB_DMG_ELECTRIC, TOUCH_SFX_WOOD }
#define SSBB_HITBOX_ELECTRIC_LARGE { 5, {0,0,0}, 50, 50, 8, SSBB_DMG_ELECTRIC, TOUCH_SFX_HARD }

// Smash attacks (stronger)
#define SSBB_HITBOX_FSMASH { 5, {20,0,0}, 40, 45, 10, SSBB_DMG_ELECTRIC, TOUCH_SFX_HARD }
#define SSBB_HITBOX_USMASH { 5, {0,20,0}, 35, 50, 12, SSBB_DMG_ELECTRIC, TOUCH_SFX_HARD }
#define SSBB_HITBOX_DSMASH { 5, {0,0,0}, 45, 30, 10, SSBB_DMG_ELECTRIC, TOUCH_SFX_HARD }

// Thunder (down-B) — large AoE, light arrow damage
#define SSBB_HITBOX_THUNDER { 0, {0,0,0}, 90, 200, 16, SSBB_DMG_MAGIC_LIGHT, TOUCH_SFX_HARD }

// Skull Bash — body hitbox while dashing
#define SSBB_HITBOX_SKULL_BASH { 5, {0,0,0}, 30, 40, 8, SSBB_DMG_SLASH, TOUCH_SFX_HARD }

// Grab (hookshot) — wide forward cylinder
#define SSBB_HITBOX_GRAB { 5, {40,0,0}, 55, 70, 2, SSBB_DMG_BOOMERANG, TOUCH_SFX_WOOD }

// Quick Attack — body hitbox during dash
#define SSBB_HITBOX_QUICK_ATK { 5, {0,0,0}, 30, 60, 4, SSBB_DMG_BOOMERANG, TOUCH_SFX_WOOD }

// Hammer
#define SSBB_HITBOX_HAMMER { 28, {0,0,0}, 40, 50, 12, SSBB_DMG_HAMMER, TOUCH_SFX_HARD }
