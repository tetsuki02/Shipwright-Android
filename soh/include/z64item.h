...
typedef enum {
    ...
    /* 0xB8 */ ITEM_MM_MASK_ALL_NIGHT,
    /* 0xB9 */ ITEM_MM_MASK_BLAST,
    /* 0xBA */ ITEM_MM_MASK_STONE,
    /* 0xBB */ ITEM_MM_MASK_GREAT_FAIRY,
    /* 0xBC */ ITEM_MM_MASK_DEKU,
    /* 0xBD */ ITEM_MM_MASK_KEATON,
    /* 0xBE */ ITEM_MM_MASK_BREMEN,
    /* 0xBF */ ITEM_MM_MASK_BUNNY,
    /* 0xC0 */ ITEM_MM_MASK_DON_GERO,
    /* 0xC1 */ ITEM_MM_MASK_SCENTS,
    /* 0xC2 */ ITEM_MM_MASK_GORON,
    /* 0xC3 */ ITEM_MM_MASK_ROMANI,
    /* 0xC4 */ ITEM_MM_MASK_CIRCUS_LEADER,
    /* 0xC5 */ ITEM_MM_MASK_KAFEI,
    /* 0xC6 */ ITEM_MM_MASK_COUPLE,
    /* 0xC7 */ ITEM_MM_MASK_TRUTH,
    /* 0xC8 */ ITEM_MM_MASK_ZORA,
    /* 0xC9 */ ITEM_MM_MASK_KAMARO,
    /* 0xCA */ ITEM_MM_MASK_GIBDO,
    /* 0xCB */ ITEM_MM_MASK_GARO,
